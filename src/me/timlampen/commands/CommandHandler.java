	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if(sender instanceof Player){
			...
			if(cmd.getName().equals("dc") || cmd.getName().equals("darknesscraft")){
				...
				if(args.length==0){
					player.sendMessage(ChatColor.GREEN + "-=-=-=-=-=-=-=" + ChatColor.DARK_AQUA + "[" + ChatColor.BLUE + "Crystals" + ChatColor.DARK_AQUA + "]" + ChatColor.GREEN + "=-=-=-=-=-=-=-");
					player.sendMessage(ChatColor.GREEN + "/crystal " + ChatColor.BLUE + "- Shows the help screen");
					player.sendMessage(ChatColor.GREEN + "/crystal balance" + ChatColor.BLUE + "- Shows amount of coins you have");
					player.sendMessage(ChatColor.GREEN + "/crystal shop" + ChatColor.BLUE + "- Opens pick upgrading shop");
					player.sendMessage(ChatColor.GREEN + "/crystal send <player> <amount>" + ChatColor.BLUE + "- Sends crystals to another player");
				}
			...
			console.sendMessage("You cannot do /dc as console!");
		}
		return false;
	}
}
